...
import com.example.ukk2025.databinding.FragmentSigninBinding
...
class signin : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvToRegister.setOnClickListener{
            findNavController().navigate(R.id.action_signin_to_daftar2)
        }
            ...
            .addOnCompleteListener(requireActivity()) {
                if (it.isSuccessful) {
                    Toast.makeText(requireContext(), "Selamat Datang $email", Toast.LENGTH_SHORT)
                        .show()
                    findNavController().navigate(R.id.action_signin_to_halaman_home)
                }else{
